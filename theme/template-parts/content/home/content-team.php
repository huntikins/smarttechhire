...
<div class="block w-full">
    ...
    ?>
    <div class="delay-[100ms] duration-[600ms] taos:translate-x-[-100%] taos:invisible" data-taos-offset="400">
        <?php echo $fields[0]['sth_team_problem']; ?>
    </div>
    <div class="delay-[300ms] duration-[600ms] taos:translate-x-[-100%] taos:invisible" data-taos-offset="400">
        <?php echo $fields[1]['sth_team_problem']; ?>
    </div>
    <div class="delay-[600ms] duration-[600ms] taos:translate-x-[-100%] taos:invisible" data-taos-offset="400">
